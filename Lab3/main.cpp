...
void task3()
{
    cout << "This program calculates the root of a linear equation ax + b = 0." << endl;
...
void task4()
{
    cout << "This program calculates the solutions of a quadratic equation ax^2 + bx + c = 0." << endl;
    ...
    if (a == 0)
    {
        if (b == 0)
        {
            if (c == 0)
            {
                cout << "Infinite number of solutions (equation is satisfied for all real numbers)." << endl;
            }
            else
            {
...
void task5()
{
    cout << "This program calculates the total annual income and the average income." << endl;
...
void task5a()
{
    ...
    cout << "Significant digits for double: " << significant_digits_double << endl;
    cout << "Significant digits for long double: " << significant_digits_long_double << endl;
}
...
void task12()
{
    cout << "This program calculates the employee's salary based on the number of hours worked and the hourly rate." << endl;
...
void task16a()
{
    ...
    while (matches > 0)
    {
        cout << "Player " << player << ", how many matches do you want to take? (1-3): ";
...
void task17()
{
    ...
    cout << "Think of a number between 1 and " << number << " and I will try to guess it." << endl;

    while (low <= high)
    {
        int guess = (low + high) / 2;

        cout << "Is your number " << guess << "? (answer with 'm'(too much) or 'l'(too little) or 'c'(correct)): ";
        char answer;
        cin >> answer;
        ...
        {
            cout << "Invalid input! Please answer with 'too much', 'too little', or 'correct'." << endl;
        }
    }
}
